const elements = Object.fromEntries(
  ['start', 'stop', 'spinner', 'stop-label', 'export', 'dot', 'meeting', 'phase', 'error', 'transcript', 'count']
    .map((id) => [id, document.getElementById(id)]),
);
let state = { ready: false, status: 'idle', apiConfigured: false, meetingDetected: false, transcriptCount: 0 };
